...
export function calculateSimpleInterest(values: Record<string, any>): CalculationResult[] {
...
export function calculateSavingsGoal(values: Record<string, any>): CalculationResult[] {
...
export function calculateDiscount(values: Record<string, any>): CalculationResult[] {
...
export function calculateDateDiff(values: Record<string, any>): CalculationResult[] {
...
export function calculateWorldClock(values: Record<string, any>): CalculationResult[] {
...
export function calculateLease(values: Record<string, any>): CalculationResult[] {
  const p = parseFloat(values.price || '0');
...
export function calculateCarLease(values: Record<string, any>): CalculationResult[] {
  return calculateLease(values);
}

export function calculateHELOC(values: Record<string, any>): CalculationResult[] {
...
export function calculateExponent(values: Record<string, any>): CalculationResult[] {
...
export function calculateLogarithm(values: Record<string, any>): CalculationResult[] {
...
export function calculateBasalMetabolic(values: Record<string, any>): CalculationResult[] {
...
export function calculateWaistHip(values: Record<string, any>): CalculationResult[] {
...
export function calculateBinary(values: Record<string, any>): CalculationResult[] {
  const d = parseInt(values.decimal || '0', 10);
  if(isNaN(d)) return [];
  return [{ label: 'Binary', value: d.toString(2), isPrimary: true }];
}

export function calculatePasswordStrength(values: Record<string, any>): CalculationResult[] {
...
export function calculateCountdown(values: Record<string, any>): CalculationResult[] {
...
export function calculateSalaryComparison(values: Record<string, any>): CalculationResult[] {
...
export function calculateStudentLoan(values: Record<string, any>): CalculationResult[] {
...
export function calculateUnitConverter(values: Record<string, any>): CalculationResult[] {
...
let newContent = content.replace(/export const calculateSimpleInterest.*\n/g, '')
