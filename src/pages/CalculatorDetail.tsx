...
const INPUT_MAP: Record<string, CalculationInput[]> = {
  ...
  'water-intake': [
    { label: 'Weight (kg)', name: 'w', type: 'number', defaultValue: 70  },
    { label: 'Exercise Mins/Day', name: 'e', type: 'number', defaultValue: 30  },
  ],
  'blood-donation': [
  ...
  'simple-interest': [
    { label: 'Principal Amount', name: 'principal', type: 'number', defaultValue: 1000 },
    { label: 'Rate of Interest (%)', name: 'rate', type: 'number', defaultValue: 5 },
    { label: 'Time', name: 'time', type: 'number', defaultValue: 2 },
    { label: 'Time Unit', name: 'timeUnit', type: 'select', defaultValue: 'years', options: [{label: 'Years', value: 'years'}, {label: 'Months', value: 'months'}] },
  ],
  'savings-goal': [
    { label: 'Goal Amount', name: 'goal', type: 'number', defaultValue: 10000 },
    { label: 'Initial Savings', name: 'initial', type: 'number', defaultValue: 1000 },
    { label: 'Monthly Contribution', name: 'monthly', type: 'number', defaultValue: 200 },
    { label: 'Expected Return (%)', name: 'rate', type: 'number', defaultValue: 5 }
  ],
  'discount': [
    { label: 'Original Price', name: 'price', type: 'number', defaultValue: 100 },
    { label: 'Discount (%)', name: 'discount', type: 'number', defaultValue: 20 }
  ],
  'date-diff': [
    { label: 'Start Date', name: 'date1', type: 'date', defaultValue: '' },
    { label: 'End Date', name: 'date2', type: 'date', defaultValue: '' }
  ],
  'world-clock': [
    { label: 'Offset from UTC (hours)', name: 'offset', type: 'number', defaultValue: 0 }
  ],

  'lease': [
    { label: 'Vehicle Price', name: 'price', type: 'number', defaultValue: 25000 },
    { label: 'Residual Value', name: 'residual', type: 'number', defaultValue: 15000 },
    { label: 'Term (Months)', name: 'term', type: 'number', defaultValue: 36 },
    { label: 'Money Factor', name: 'moneyFactor', type: 'number', defaultValue: 0.00125 }
  ],
  'heloc': [
    { label: 'Home Value', name: 'homeValue', type: 'number', defaultValue: 400000 },
    { label: 'Mortgage Balance', name: 'mortgageBalance', type: 'number', defaultValue: 250000 },
    { label: 'Max LTV (%)', name: 'maxLTC', type: 'number', defaultValue: 80 }
  ],
  'exponent': [
    { label: 'Base', name: 'base', type: 'number', defaultValue: 2 },
    { label: 'Exponent', name: 'exponent', type: 'number', defaultValue: 3 }
  ],
  'logarithm': [
    { label: 'Number', name: 'num', type: 'number', defaultValue: 100 },
    { label: 'Base', name: 'base', type: 'number', defaultValue: 10 }
  ],
  'basal-metabolic': [
    { label: 'Weight (kg)', name: 'weight', type: 'number', defaultValue: 70 },
    { label: 'Height (cm)', name: 'height', type: 'number', defaultValue: 175 },
    { label: 'Age', name: 'age', type: 'number', defaultValue: 30 },
    { label: 'Gender', name: 'gender', type: 'select', defaultValue: 'male', options: [{label:'Male', value:'male'}, {label:'Female', value:'female'}] },
  ],
  'waist-hip': [
    { label: 'Waist (cm/in)', name: 'waist', type: 'number', defaultValue: 80 },
    { label: 'Hip (cm/in)', name: 'hip', type: 'number', defaultValue: 100 }
  ],
  'binary': [
    { label: 'Number', name: 'num', type: 'number', defaultValue: 10 }
  ],
  'password-strength': [
    { label: 'Password', name: 'password', type: 'text', defaultValue: '' }
  ],
  'countdown': [
    { label: 'Target Date', name: 'date', type: 'date', defaultValue: '' }
  ],
  'salary-comparison': [
    { label: 'Current Salary', name: 'salary1', type: 'number', defaultValue: 50000 },
    { label: 'New Salary', name: 'salary2', type: 'number', defaultValue: 60000 }
  ],
  'car-lease': [
    { label: 'Car Price', name: 'price', type: 'number', defaultValue: 30000 },
    { label: 'Residual Value', name: 'residual', type: 'number', defaultValue: 18000 },
    { label: 'Term (Months)', name: 'term', type: 'number', defaultValue: 36 },
    { label: 'Money Factor', name: 'moneyFactor', type: 'number', defaultValue: 0.0015 }
  ],
  'student-loan': [
    { label: 'Loan Amount', name: 'principal', type: 'number', defaultValue: 30000 },
    { label: 'Interest Rate (%)', name: 'rate', type: 'number', defaultValue: 5 },
    { label: 'Term (Years)', name: 'term', type: 'number', defaultValue: 10 }
  ],
  'macros': [
    { label: 'Target Calories', name: 'calories', type: 'number', defaultValue: 2000 }
  ],
  'unit-converter': [
    { label: 'Value', name: 'value', type: 'number', defaultValue: 1 },
    { label: 'Conversion Multiplier', name: 'factor', type: 'number', defaultValue: 1 }
  ],
  ...
  'dividend': [
    { label: 'Stock Price', name: 'valB', type: 'number', defaultValue: 150, unit: '$' },
    { label: 'Annual Dividend', name: 'valA', type: 'number', defaultValue: 5, unit: '$' },
    { label: 'Operation', name: 'operation', type: 'hidden', defaultValue: 'what_percent' },
  ],
  'monthly-budget': [
  ...
  'percentage': [
    { label: 'Operation', name: 'operation', type: 'select', defaultValue: 'percentage_of', options: [
      { label: 'What is P% of V?', value: 'percentage_of' },
